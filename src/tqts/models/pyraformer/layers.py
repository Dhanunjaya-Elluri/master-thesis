...
from tqts.models.pyraformer.sublayers import MultiHeadAttention, PositionwiseFeedForward
import torch
from tqts.models.pyraformer.embed import DataEmbedding, CustomEmbedding
import math
...
class EncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        if use_tvm:
            from tqts.models.pyraformer.PAM_TVM import PyramidalAttention
