...
class ETTHourDataset(Dataset):
    """Dataset class for handling ETT Hourly quantized time series generated by KernelSAX.
...
class ETTDailyDataset(Dataset):
    ...
    def __init__(
        ...
        if self.size is None:
            self.seq_len = (24 * 4 * 4) // 24
            self.pred_len = (24 * 4) // 24
        else:
            self.seq_len, self.pred_len = self.size
    ...
    def __read_data__(self):
        ...
        # border1s = [
        #     0,
        #     (12 * 30 * 24 - self.seq_len) // 24,
        #     (12 * 30 * 24 + 4 * 30 * 24 - self.seq_len) // 24,
        # ]
        # border2s = [
        #     (12 * 30 * 24) // 24,
        #     (12 * 30 * 24) // 24 + (4 * 30 * 24) // 24,
        #     (12 * 30 * 24) // 24 + (8 * 30 * 24) // 24,
        # ]
...
class ETTMinDataset(Dataset):
    """Dataset class for handling ETT Minute quantized time series generated by KernelSAX.
...
class ETTHPredDataset(Dataset):
    """A dataset class for the prediction phase of the Informer models.
    ...
    Attributes:
        ...
        train_only: Flag to indicate training only mode.
    """
