...
"""Experiment script for the Informer model."""
...
from tqts.data.ett_data import ETTHDataset, ETTHPredDataset
from tqts.model.informer import Informer, InformerStack
from tqts.utils.metrics import metric
from tqts.utils.tools import EarlyStopping, adjust_learning_rate
